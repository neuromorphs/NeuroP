...
from neurop import BaseProblem, BaseModel, BaseCompiler
...
class ILPQUBOCompiler(BaseCompiler):
    def __init__(self, problem: BaseProblem, backend: BaseBackend = None, expansion = expand_integer_to_binary_encoding, penalty=1) -> None:
